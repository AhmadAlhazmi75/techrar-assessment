...
const Content = () => {
  return (
    <div className="relative z-20 mx-auto mt-8 flex max-w-6xl flex-col items-center justify-center px-4 py-24 md:px-8 md:py-36">
      <motion.div
        initial={{
          y: 25,
          opacity: 0,
      ...
      >
            Chat with your System Documentation in a new way.
      </motion.h1>
      <motion.p
        initial={{
          y: 25,
